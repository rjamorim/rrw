...
<HTML>
<HEAD>
<TITLE>ReallyRareWares - Liquid Audio</TITLE>
...
<br><br><br><br><br><br>
    ...
    <table border="0" cellpadding="0" cellspacing="0" width="100%">
      ...
      <tr><td>
        ...
        industry living on borrowed time.<br><br>
        ...
        sales and distribution. Despite initially being based on the <a 
        href=softencode.php>Dolby AC3</a> format, it only started catching 
        people's attention after it added AAC support.<br><br>
        ...
        Interface: Graphical<br>
        Platform: Win32<br>
        Download: <a href="files/aac/liquid/liquifier4.zip">liquifier4.zip</a> - 1.587kB<br>
        <br>
        Date: 1999-08-07<br>
        Version: 5.0 b23<br>
        Interface: Graphical<br>
        Platform: Win32<br>
        Download: <a href="files/aac/liquid/lmp50026b.exe">lmp50026b.exe</a> - 1.783kB<br>
        <br>
        Date: 2001-04-12<br>
        Version: 5.1.0<br>
        Interface: Graphical<br>
        Platform: Mac OS Classic (PPC)<br>
        Download: <a href="files/aac/liquid/LiquidPlayer5.1Installer.sit">LiquidPlayer5.1Installer.sit</a> - 4.674kB<br>
        <br>
        Date: 2000-08-10<br>
        Version: 2.0<br>
