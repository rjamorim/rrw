...
<HTML>
<HEAD>
<TITLE>ReallyRareWares - LBPack</TITLE>
    ...
    <table border="0" cellpadding="0" cellspacing="0" width="100%">
      ...
      <tr><td>
        ...
        <font face="Verdana" size=2 color="6699CC">
          <br><div align="justify"> <b>LBPack</b></div> <p>
        </font>
        <font face="Tahoma" size=2 color="black"><blockquote>
        <a href="screens/lbpack.png" target=outside><img src="screens/lbpack.png" 
        alt="LBPack player" align=right height=263></a>
        LBPack (Low Bitrate Packer and Player) was created around 1997 by Dmitry 
        Shmunk, an engineer working at the Budker Institute of Nuclear Physics 
        in Russia. He later went on to work at QDesign in Canada, and LBpack 
        became the <a href="qdmc.php">QDesign Music Codec</a>.<br><br>
        
        It is optimized for extremely low bitrates (the default is 22kbps!). And 
        indeed it delivers acceptable quality at these bitrates. But the codec is 
        so aggressive that even at higher rates it can not achieve transparency.
        <br><br>
