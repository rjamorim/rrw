...
<HTML>
<HEAD>
<TITLE>ReallyRareWares - FhG MP3 codecs</TITLE>
...
<br><br><br><br><br><br><br><br>
    ...
    <table border="0" cellpadding="0" cellspacing="0" width="100%">
      ...
      <tr><td>
        ...
        recorders, transcoders, etc) to export to MP3.<br><br>
        
        These codecs were based on the FhG MP3 encoders of the time: <a 
        ...
        Date: 1999-04-16<br>
        Version: 1.5<br>
        Interface: QuickTime component<br>
        Platform: Mac OS Classic PPC<br>
        Bitrate range: 20-256kbps<br>
        Download: <a href="files/fhg/Fraunhofer_MP3_Codec.hqx">Fraunhofer_MP3_Codec.hqx</a> - 1.289kB<br>
