...
<br><br><br><br><br><br><br><br><br>
    ...
    <table border="0" cellpadding="0" cellspacing="0" width="100%">
      ...
      <tr><td>
        ...
        As one would expect it avoids some calculations to increase decoder 
        performance, so audio quality is not on par with accurate decoders.<br><br>
        
        The decoder is very limited. It only supports 44.1kHz stereo MP3 files 
        (and complains that 48kHz files are "low quality").<br><br>
        
        It does not have a native interface. Whenever the program is closed, the
        user is asked whether to change the skin the next time the player is 
        executed. I included two skins with the file offered here.<br><br>
        
        It is also light on features. No playlist manager, no equalizer, no 
        tagging, no WAV file playback...<br><br>
